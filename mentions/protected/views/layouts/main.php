	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
				...
				array('label'=>'Mentions', 'url'=>array('/site/mentions')),

				array('label'=>'Usuarios', 'url'=>array('/empleados')),
...
<script src='<?php echo Yii::app()->request->baseUrl; ?>/js/underscore-min.js' type='text/javascript'></script>
  ...
  <script src='<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.mentions.js' type='text/javascript'></script>
